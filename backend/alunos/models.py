...
class Aluno(models.Model):
    ...
    # LGPD
    aceite_lgpd        = models.BooleanField(default=False, verbose_name='Aceitou a LGPD')
    data_aceite_lgpd   = models.DateTimeField(null=True, blank=True, verbose_name='Data do aceite LGPD')
...
class EvolutionFisica(models.Model):
    ...
    class Meta:
        verbose_name        = 'Evolucao Fisica'
        verbose_name_plural = 'Evolucoes Fisicas'
        ordering            = ['-data']
